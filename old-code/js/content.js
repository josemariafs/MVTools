  ...
  if (ignoredUser) {
    for (var i = 0, l = privateMessages.length; i < l; i++) {
      if (ignoredUser && ignoredUser.includes(privateMessages[i].textContent)) {
        privateMessages[i].parentNode.parentNode.parentNode.parentNode.parentNode.innerHTML =
...
if (window.location.href.startsWith('https://www.mediavida.com/usuarios/admin')) {
...
if (window.location.href.startsWith('https://www.mediavida.com/foro/admin_edit.php')) {
  document.querySelector('body').classList.add('mvAdminTools')
...
if (window.location.href.startsWith('https://www.mediavida.com/foro/staff.php')) {
  document.querySelector('body').classList.add('mvAdminTools')
...
if (window.location.href.startsWith('https://www.mediavida.com/id')) {
  ...
  document.querySelector('.left').nextElementSibling.querySelectorAll('li')[0].style =
  ...
  document.querySelector('.left').nextElementSibling.querySelectorAll('li')[1].style =
    'margin: 10px; background: #3e3e3ecf; border-radius: 3px; border: 1px #656565 solid; padding: 5px; text-align: center; color:white !important'
  document.querySelector('.left').nextElementSibling.querySelectorAll('li')[2].style =
    'margin: 10px; background: #3e3e3ecf; border-radius: 3px; border: 1px #656565 solid; padding: 5px; text-align: center; color:white !important'
}
...
if (window.location.href.startsWith('https://www.mediavida.com/usuarios/clones')) {
  document.querySelector('body').classList.add('mvAdminTools')
  ...
  if (window.localStorage.getItem('showIpsWithoutClons') === 'false') {
    for (var i = 0; i < document.getElementsByClassName('box')[0].getElementsByTagName('div').length; i++) {
      if (document.getElementsByClassName('box')[0].getElementsByTagName('div')[i]) {
        if (document.getElementsByClassName('box')[0].getElementsByTagName('div')[i].textContent.includes('ninguno')) {
          document.getElementsByClassName('box')[0].getElementsByTagName('div')[i].style.display = 'none'
        }
      }
    }
  }
  ...
  newFieldset.innerHTML += `
        ...
        <div class="control-input" >
            ...
            ${window.localStorage.getItem('showIpsWithoutClons') === 'true' ? 'checked' : ''}>
...
if (window.location.href.startsWith('https://www.mediavida.com/configuracion')) {
  ...
  if (window.localStorage.getItem('MvPremiumCSS') === 'true') {
    newFieldset.innerHTML += `
      ...
      <div class="control-input" style="margin-bottom: 20px;">
          ...
          ${window.localStorage.getItem('MvPremiumCSSWithoutBG') === 'true' ? 'checked' : ''}>
          <div class="slider round"></div>
      </label>
      <a href="#!" class="tooltipAnchorConfig" data-tooltip="Se recomienda usar el Theme de Mediavida Oscuro cuando se activan los estilos de MV Premium ">?</a>
      </div>
  ...
  if (window.localStorage.getItem('MvPremiumCSS') === 'true') {
    ...
    <div class="control-input" style="margin-bottom: 20px;">
        ...
        ${window.localStorage.getItem('mvultrawide') === 'true' ? 'checked' : ''}>
        <div class="slider round"></div>
    </label>
    <a href="#!" class="tooltipAnchorConfig" data-tooltip="Se recomienda usar el Theme de Mediavida Oscuro cuando se activan los estilos de MV Premium ">?</a>
    </div>
...
if (window.location.href.startsWith('https://www.mediavida.com/usuarios/clones')) {
  document.querySelector('#show-all-ips').addEventListener('click', function (e) {
    return HandleOnChangeShowIpsWithoutClons(document.getElementById('show-all-ips').checked)
  })
}
...
if (window.location.href.startsWith('https://www.mediavida.com/foro/reportes')) {
  ...
  document.querySelector('#analizarReportes').addEventListener('click', function (e) {
...
if (window.location.href.startsWith('https://www.mediavida.com/configuracion')) {
  document.querySelector('#export-config').addEventListener('click', function (e) {
    return exportConfig()
  })
  document.querySelector('#import-config').addEventListener('click', function (e) {
    return importConfig()
  })

  document.querySelector('#apiKeyBtn').addEventListener('click', function (e) {
  ...
  if (document.getElementById('checkbox').checked) {
    document.querySelector('#checkbox-without-bg').addEventListener('click', function (e) {
      return HandleOnChangeHideBg(document.getElementById('checkbox-without-bg').checked)
    })

    document.querySelector('#checkbox-ultrawide').addEventListener('click', function (e) {
      return HandleOnChangeUltrawide(document.getElementById('checkbox-ultrawide').checked)
    })
  }
