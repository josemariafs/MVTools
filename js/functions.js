...
function importConfig(){
    ...
    function analizarComentarioIA(comentario, acción, target) {
        ...
        switch (acción) {
            case "normas":
                prompt = "Analiza y dime el numero de normas incumple del siguiente texto '" + normas + "' el siguiente comentario: " + comentario + ". Devuelveme el resultado en formato html table con clase 'reporte-ia'. Esta tabla html debe de tener dos columnas. Columna 0: 'Norma' y columna 1: 'Motivo'. ";
                break;
            case "resumen":
