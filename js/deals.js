...
function DealToMv() {
        ...
        window.open("https://www.mediavida.com/foro/club-hucha/nuevo-hilo?title="+titleEncoded+"&enlace="+enlace+"&description="+descriptionMdEncoded+"&category="+category, "_blank");
    }
